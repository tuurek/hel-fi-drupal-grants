...
class GrantsAttachmentData extends Map {
  ...
  public function setValue($values, $notify = TRUE) {
     ...
     *
     * This is because integration does not update new attachment value
     * in content even if they do update other values.
     *
     * If this is true, integration waits for another file to arrive, and
     * empties ALL other attachments.
     *
     */
