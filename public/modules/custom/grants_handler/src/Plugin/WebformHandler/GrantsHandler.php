...
class GrantsHandler extends WebformHandlerBase {
   ...
   *
   * @return \Drupal\Core\Access\AccessResultNeutral|\Drupal\Core\Core\AccessResultInterface
   */
  ...
  public function postSave(WebformSubmissionInterface $webform_submission, $update = TRUE) {
    ...
    if ($this->triggeringElement == '::submitForm') {
      ...
      if ($applicationUploadStatus) {
        ...
        // Try to give integration time to do it's thing before we try to go there.
        sleep(2);
