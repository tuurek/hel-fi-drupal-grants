...
class GrantsHandlerSubmissionStorage extends WebformSubmissionStorage {
  ...
  protected function saveRevision(ContentEntityInterface $entity) {
    return parent::saveRevision($entity); // TODO: Change the autogenerated stub
  }

  protected function saveToSharedTables(ContentEntityInterface $entity, $table_name = NULL, $new_revision = NULL) {
    parent::saveToSharedTables($entity, $table_name, $new_revision); // TODO: Change the autogenerated stub
  }

  protected function saveToDedicatedTables(ContentEntityInterface $entity, $update = TRUE, $names = []) {
    parent::saveToDedicatedTables($entity, $update, $names); // TODO: Change the autogenerated stub
  }

  public function resave(EntityInterface $entity) {
    return parent::resave($entity); // TODO: Change the autogenerated stub
  }
  ...
  public function saveData(WebformSubmissionInterface $webform_submission, $delete_first = TRUE) {
    $d = 'asdf';
    //    parent::saveData($webform_submission, $delete_first); // TODO: Change the autogenerated stub
  }
