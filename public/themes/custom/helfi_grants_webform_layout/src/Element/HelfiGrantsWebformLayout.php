 ...
 */
class HelfiGrantsWebformLayout extends FormElement {
  ...
  public function getInfo() {
    ...
    return [
      ...
      '#element_validate' => [
        [$class, 'validateHelfiGrantsWebformLayout'],
      ],
      '#pre_render' => [
        [$class, 'preRenderHelfiGrantsWebformLayout'],
      ],
   ...
   */
  public static function validateHelfiGrantsWebformLayout(&$element, FormStateInterface $form_state, &$complete_form) {
   ...
   */
  public static function preRenderHelfiGrantsWebformLayout(array $element) {
